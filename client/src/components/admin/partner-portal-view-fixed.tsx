...
// Importação dinâmica para os componentes do parceiro
// Utilizamos React.lazy para carregar apenas quando necessário
const PartnerDashboard = lazy(() => import('@/pages/partner-dashboard'));
const PartnerStudentDocumentsPage = lazy(() => import('@/pages/partner-student-documents-page'));
const PartnerCertificationRequestsPage = lazy(() => import('@/pages/partner-certification-requests-page'));
